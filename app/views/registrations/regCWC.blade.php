...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Register CWC</li>
    </ol>
</section>
@stop
...
<section class="content invoice">
    ...
    <div class="row">
        <div class="col-xs-12">
            <h2 class="page-header">Register CWC</h2>
        </div><!-- /.col -->
    </div>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="regToday">Registration Today</label>
                            <select class="form-control" id="regToday" name="regToday">
    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="box-footer">
                {{ Form::submit('Register CWC',array('class'=>'btn btn-primary')) }}
            </div>
        </div>
    </div>
    {{ Form::close() }}
