...
<section class="content invoice">
    ...
    <div class="row">
        <div class="col-xs-12">
            <h2 class="page-header">Add ANC Visit</h2>
        </div><!-- /.col -->
    </div>
                ...
                <div class="box-body">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('visitor',Input::old('visitor'),array('class'=>'form-control','placeholder'=>'Enter visitor')) }}
                        </div>
